...
[![Artifact HUB](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/peak-scale)](https://artifacthub.io/packages/search?repo=peak-scale)
...
```shell
helm repo add peak-scale https://peak-scale.github.io/helm-charts/
```
